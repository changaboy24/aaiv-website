...
function (e) {
    e.extend(e.fn, {
        ...
        rules: function (t, n) {
            ...
            var f = e.validator.normalizeRules(e.extend({}, e.validator.metadataRules(r), e.validator.classRules(r), e.validator.attributeRules(r), e.validator.staticRules(r)), r);
            if (f.required) {
                var l = f.required;
            ...
            check: function (t) {
                ...
                for (var o in n) {
                    ...
                    try {
                        ...
                        throw this.settings.debug && window.console && console.log("exception occured when checking element " + t.id + ", check the '" + u.method + "' method", f), f
                    }
                }
                if (r) return;
                ...
                return o[n.name] = t, e.ajax(e.extend(!0, {
                    ...
                    success: function (r) {
                        ...
                        if (o) {
                            ...
                            var l = {}, h = r || s.defaultMessage(n, "remote");
...
function () {
    jQuery(function () {
        ...
        return $("a[rel*=external]").click(function (e) {
            return window.open($(this).attr("href")), e.preventDefault()
        }), $("nav#sites li a, a.hire").click(function (e) {
            var t;
            return e.preventDefault(), t = $("" + $(this).attr("href")).offset().top, $("html,body").animate({
                scrollTop: t
            }, {
                easing: "swing",
                duration: 500
            })
        }), $("ul#work li").waypoint(function (e, t) {
            var n, r;
            return $("nav#sites ul li a").removeClass("current"), r = $(this).attr("id"), n = $("nav#sites ul li a." + r), t === "down" ? n.addClass("current") : n.parent().prev().find("a").addClass("current")
        }), $("#intro").waypoint(function () {
            return $("nav#sites ul li a").removeClass("current"), $("nav#sites ul li a:first").addClass("current")
        }, {
            offset: -30
